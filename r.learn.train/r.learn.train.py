...
#%flag
#% key: k
#% label: Perform permutation score based feature selection
#% description: Perform feature selection using the n-best features selected from the permutation scores
#% guisection: Tuning
#%end
